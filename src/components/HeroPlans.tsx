      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-foreground">
            Transforme seu <span className="text-gradient-blue">Corpo</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Escolha o plano ideal para você e comece sua jornada com Reginaldo Gárcia
          </p>
        </motion.div>
...
const PlanCard = ({ plan }: { plan: Plan }) => {
  return (
    <motion.div
      ...
      className={`relative ${plan.isPopular ? 'clean-card-highlight' : 'clean-card'} p-6 group bg-background`}
      whileHover={{
        y: -8,
        scale: 1.02,
